	...
	public String getFrontPageStr()
	  {
	    ...
	    if (this.totalPage > 1)
	    {
	      int section = this.currentPage / showPageNum;
	      int startPage = section * showPageNum + 1;
	      int endPage = section * showPageNum + showPageNum;
	      if (this.totalPage < endPage) {
	        endPage = this.totalPage;
	      }
	      sb.append("<div class=\"numeric-pagination\"> \n");
	      if (this.currentPage != 1) {
	        sb.append(" <a href=\"#\" class=\"button\" onclick=\"nextPage(" + (this.currentPage - 1) + ")\"><i class=\"icons icon-left-dir\"></i></a>\n");
	      }
	      for (int i = startPage; i <= endPage; i++) {
	        if (i == this.currentPage) {
	          sb.append(" <a href=\"#\" class=\"selectedPageBtn\">" + this.currentPage + "</a>\n");
	        } else {
	          sb.append(" <a href=\"#\" class=\"button\" onclick=\"nextPage(" + i + ")\">" + i + "</a>\n");
	        }
	      }
	      if (this.currentPage != this.totalPage) {
	        sb.append(" <a href=\"#\" class=\"button\" onclick=\"nextPage(" + (this.currentPage + 1) + ")\"><i class=\"icons icon-right-dir\"></i></a>\n");
	      }
	      sb.append("</div>\n");
	      ...
	      sb.append("  var url = getPagingUrl();\n");
	    ...
	    this.frontPageStr = sb.toString();
	    return this.frontPageStr;
	  }
