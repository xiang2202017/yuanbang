			...
			<div class="widget-body">
				...
				<div class="widget-main">
								<div class="step-content row-fluid position-relative">
									...
									<form action="<%=basePath%>back/updateMemberJoin" name="memberJoinForm" id="memberJoinForm" method="post">
										...
										<div id="zhongxin">
											<table style="width:100%;" id="xtable">
												...
												<tr>
													<td align="right">会员留言</td>
													<td>
														<textarea name="message" id="message" readonly="readonly" rows="5" cols="10">${pd.message}</textarea>
													</td>
												</tr>
												...
												<c:if test="${pd.status == '1' }">
													...
													<tr id="failTr_1">
														...
														<td><textarea id="disposeDesc" name="disposeDesc" rows="5" cols="10"></textarea></td>
													</tr>
													<tr>
														<td></td>
														<td id="nr" align="right">
															<button type="button" onclick="formSubmit()">通过</button>
