			  ...
			  <ul class="nav ace-nav pull-right">
					...
					<li class="grey">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							<li class="nav-header">
								<i class="icon-ok"></i> 6任务待完成
							</li>
							
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<div class="clearfix">
										<span class="pull-left">会员加盟申请</span>
										<span class="pull-right">2017-8-15</span>
									</div>
								</a>
							</li>
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<div class="clearfix">
										<span class="pull-left">会员续约申请</span>
										<span class="pull-right">2017-9-12</span>
									</div>
								</a>
							</li>
...
// $(function(){if('main'== path[3]){path =  path[0]+'//'+path[2];}else{path =  path[0]+'//'+path[2]+'/'+path[3];};});
// 修改个人资料
// function editUserH(){
// 	alert(USER_ID);
// 	 jzts();
...
// 	 diag.Title ="个人资料";
// 	 alert(locat);
// 	 diag.URL = path+'/back/goEditU.do?USER_ID='+USER_ID+'&fx=head';
// 	 alert(diag.URL);
// 	 diag.Width = 350;
// 	 diag.Height = 450;
