									...
									<div id="zhongxin">
										<table style="width:100%;" id="xtable">
											...
											<tr>
												...
												<td style="margin-top:0px;">
													<input type="text" name="idcardNo" id="idcardNo" readonly="readonly" value="${pd.idcardNo}"/>
												</td>
											</tr>
											<tr>
												<td align="right">会员邮箱</td>
												<td style="margin-top:0px;">
													<input type="text" name="mail" id="mail" readonly="readonly" value="${pd.mail}"/>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													 <textarea name="message" id="message" readonly="readonly">${pd.message}</textarea>
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													...
													<c:if test="${pd.status == '2' }">已加盟</c:if>
													<c:if test="${pd.status == '3' }">已过期</c:if>
												</td>
											</tr>
											<c:if test="${pd.status == '2' }">
												<tr>
													<td width="20%" align="right">处理说明</td>
													<td><textarea  readonly="readonly">${pd.disposeDesc }</textarea>
