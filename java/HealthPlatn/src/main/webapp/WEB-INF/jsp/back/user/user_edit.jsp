...
<body style="padding-top: 10px">
	<form action="back/${msg }.do" name="userForm" id="userForm" method="post" style="padding-left: 10px">
		...
		<table>
			...
			<tr class="info">
				...
				<c:forEach items="${roleList}" var="role">
					<c:choose>
						<c:when test="${role.ROLE_ID == pd.ROLE_ID }">
