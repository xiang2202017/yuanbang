			...
			<div class="widget-body">
				...
				<div class="widget-main">
								<div class="step-content row-fluid position-relative">
									...
									<form action="<%=basePath%>back/updateMemberCancel" name="memberCancelForm" id="memberCancelForm" method="post">
										...
										<div id="zhongxin">
											<table style="width:100%;" id="xtable">
												...
												<tr>
													...
													<td>
														<textarea name="cancelReason" id="cancelReason" readonly="readonly" rows="5" cols="10">${pd.cancelReason}</textarea>
													</td>
												</tr>
												...
												<c:if test="${pd.status == '1' }">
													...
													<tr>
														...
														<td id="nr" align="right">
															<button type="button" onclick="formSubmit(1)">保存</button>
												...
												<c:if test="${pd.status == '2' }">
													<tr>
														<td></td>
														<td id="nr" align="right">
															<button type="button" onclick="formSubmit(2)">解约</button>
															<button type="reset" onclick="cancel()">取消</button>
														</td>
													</tr>
												</c:if>
