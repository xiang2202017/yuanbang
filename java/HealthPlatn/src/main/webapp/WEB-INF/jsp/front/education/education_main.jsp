...
<script type="text/javascript">
	...
	//获取产品详情
	function getDetail(educationId){
		var urlstr = "<%=basePath%>web/toEducationView.do";
		$.ajax({
            url:urlstr,
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-4 sidebar">
												...
												<c:choose>
													<c:when test="${vs.index == 0 && svs.index == 0 }">
														<li style="text-indent: 20px;">
															...
															<div class="shop-item-content">
																<h6><a id="menu${sub.id }" style="cursor: pointer;font-weight: bold;font-size: 16px" onclick="openEducationMenu('${sub.id}')">${sub.name }</a></h6>
															</div>
														</li>
													</c:when>
													<c:otherwise>
														<li style="text-indent: 20px">
															<div class="shop-item-content">
																<h6><a id="menu${sub.id }" style="cursor: pointer;" onclick="openEducationMenu('${sub.id}')">${sub.name }</a></h6>
															</div>
														</li>
													</c:otherwise>
												</c:choose>
					...
					<div class="sidebar-box white animate-onscroll">
						...
						<div id="phoneF">
							${education != null ? education.joinPhone : ''}
						</div>
				...
				<div class="col-lg-9 col-md-9 col-sm-8">
						<div id="listDiv">
							<jsp:include page="education_view.jsp"></jsp:include>
						</div>
				</div>			
			</div>
		</section>
